...
class TestLanguageNumericAnalyze:
    def test_analyze_language_numeric(self):
        ...
        assert stats["max_n"] == [5] * ANALYZE_MIN_MAX_TOP_N
        assert stats["min_n"] == [0] * ANALYZE_MIN_MAX_TOP_N
...
class TestLanguageNumericAnalyzeReduce:
    def test_analyze_reduce_language_numeric(self):
        stats1 = {
            "has_nan": False,
            "max_n": [5] * ANALYZE_MIN_MAX_TOP_N,
            "min_n": [0] * ANALYZE_MIN_MAX_TOP_N,
            "max_scale": 0,
        }
        stats2 = {
            "has_nan": True,
            "max_n": [10] * ANALYZE_MIN_MAX_TOP_N,
            "min_n": [6] * ANALYZE_MIN_MAX_TOP_N,
            "max_scale": 1,
        }
